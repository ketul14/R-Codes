...
#--------------------------------------------------------------
# 1.5 Remove columns with 1 distinct value
#--------------------------------------------------------------
removeColsWithUnique <- function(df){
  
  newdf <- Filter(function(x)(length(unique(x))>1), df)
...
#--------------------------------------------------------------
# 1.6 Remove NA rows in cols
#--------------------------------------------------------------
removeRowswithNA <- function(df, cols) {
  completeVec <- complete.cases(df[, cols])
